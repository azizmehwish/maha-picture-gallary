...
<div className='absolute top-1 right-1'
    ...
    >
        {fav?  (<AiFillHeart className='w-8 h-8 cursor-pointer text-red-700'/>):( <AiOutlineHeart className='w-8 h-8 cursor-pointer text-whithover:text-red-600 duration-300'/>)}
